...
export const numberIncrements = (i: number): boolean => incrementRegex.test(i.toString());

export const hasMinDouble = (i: number): boolean => minDoubleRegex.test(i.toString());
