...
import { Puzzle201907, runAplifiersWithPhases, runAmplifierLoop } from './201907';
...
describe('201907', () => {
  ...
  test('Part 1 Example 2', () => {
    ...
    day.loadData(`3,23,3,24,1002,24,10,24,1002,23,-1,23,101,5,23,23,1,24,23,23,4,23,99,0,0`);
